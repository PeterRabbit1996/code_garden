...
/* Initialize structure containing state of computation.
   (FIPS 180-2:5.3.2)  */
void DLL_EXPORT sha256_init_ctx(struct sha256_ctx *ctx) {
	ctx->H[0] = 0x6a09e667;
	ctx->H[1] = 0xbb67ae85;
	ctx->H[2] = 0x3c6ef372;
	ctx->H[3] = 0xa54ff53a;
...
void DLL_EXPORT *sha256_finish_ctx(struct sha256_ctx *ctx, void *resbuf) {
...
void DLL_EXPORT sha256_process_bytes(const void *buffer, UINTN len, struct sha256_ctx *ctx) {
